...
export const updateBoxLayout = (boxLayout: any, data: any) => {
  return {
    ...boxLayout,
    ...data
  }
...
export const updateBoxPosition = (boxLayout: any, data: any) => {
...
export const positionsAreColliding = (positionA: Position, positionB: Position) => {
...
export const isFree = (layout: any, position: any) => {
...
export const bubbleUp = (layout: any, boxLayout: any) => {
  do {
...
export const moveBoxToFreePlace = (layout: any, boxLayout: any, doBubbleUp: any) => {
  if (doBubbleUp) {
...
export const layoutBubbleUp = (layout: any) => {
...
export const positionToPixels = (position: Position, cellSize: Position, margin = 0, outerMargin = 0) => {
  return {
...
export const getLayoutSize = (layout: any) => {
  return {
    w: layout.reduce((width: number, boxLayout: any) => {
      return boxLayout.hidden
        ? width
        : Math.max(width, boxLayout.position.x + boxLayout.position.w)
    }, 0),
    h: layout.reduce((height: number, boxLayout: any) => {
      return boxLayout.hidden
        ? height
...
export const matchesSelector = (el: any, selector: any) => {
...
export const fixLayout = (layout: any, doBubbleUp: any) => {
  layout = sortLayout(layout)
  let fixedLayout: any[] = []
  layout.forEach(boxLayout => {
